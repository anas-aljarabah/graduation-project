...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Label ID="Label1" runat="server" Style="color:green;"></asp:Label>
        ...
        <div class="form-group">
            <div class="form-label-group">
              <asp:TextBox ID="TextBox1" runat="server" class="form-control " placeholder="E-mail"></asp:TextBox>
    ...
    <div class="card card-register mx-auto mt-5">
            ...
            <div class="card-body">
                ...
                <asp:Label ID="Label9" runat="server" Display="Dynamic" Style="color:red;"></asp:Label>
