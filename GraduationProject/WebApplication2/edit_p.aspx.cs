...
namespace WebApplication2
{
    public partial class WebForm8 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                int t = Convert.ToInt32(Session["ID"]);
                ...
                con.Close();
                con.Open();
                string qry1 = "select ssn,fname,lname,phone,data_birth,boold_type from sign_up_patient where P_ID='" + t + "' ";
                ...
                string dataofbirth1 = sdr1["data_birth"].ToString();
                string blood = sdr1["boold_type"].ToString();
                int index = dataofbirth1.IndexOf(" ");
                ...
                lname.Text = lname1;
                phone.Text = phone1;
                txtDatePicker.Text = dataofbirth1.Substring(0, index);
            ...
            if (username.Text== w) {
                ...
                con.Open();
                string qry1 = "update  sign_up_patient set ssn ='" + ssn.Text + "',fname ='" + fname.Text + "',lname ='" + lname.Text + "',phone ='" + phone.Text + "',data_birth='" + oDate + "',boold_type='" + blood_type.SelectedValue + "' where P_ID='" + t + "' ";
                SqlCommand cmd1 = new SqlCommand(qry1, con);
            ...
            else
            {
                ...
                {
                    con.Open();
                    string qry1 = "update  sign_up_patient set ssn ='" + ssn.Text + "',fname ='" + fname.Text + "',lname ='" + lname.Text + "',phone ='" + phone.Text + "',data_birth='" + txtDatePicker.Text + "',boold_type='" + blood_type.SelectedValue + "' where P_ID='" + t + "' ";
                    SqlCommand cmd1 = new SqlCommand(qry1, con);
                    cmd1.ExecuteNonQuery();
                    con.Close();
                    con.Open();
