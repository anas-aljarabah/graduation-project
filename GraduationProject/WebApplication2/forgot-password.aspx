    ...
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        <div class="text-center mb-4">
          ...
          <p>Enter your email address and we will send you your old password. (Encrypted)</p>
        </div>
        <form runat="server">
          <div class="form-group">
            <div class="form-label-group">
              <asp:TextBox ID="inputEmail" runat="server" OnTextChanged="inputEmail_TextChanged"></asp:TextBox>
          ...
          <asp:Button class="btn btn-primary btn-block" onclick="Reset" ID="Button1" runat="server" Text="Button" />
